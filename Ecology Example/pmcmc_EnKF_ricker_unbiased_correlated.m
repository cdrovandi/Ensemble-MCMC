function [theta, loglikes] = pmcmc_EnKF_ricker_unbiased_correlated(y,theta_init,iters,N,cov_rw,sigma_corr)
...
loglike_curr =  EnKF_ricker_shift_unbiased_fixed([theta_curr(1) theta_curr(2) exp(theta_curr(3)) exp(theta_curr(4)) theta_curr(5)],y,N,r);
...
i    
    ...
    loglike_prop =   EnKF_ricker_shift_unbiased_fixed([theta_prop(1) theta_prop(2) exp(theta_prop(3)) exp(theta_prop(4)) theta_prop(5)],y,N,r_prop);
