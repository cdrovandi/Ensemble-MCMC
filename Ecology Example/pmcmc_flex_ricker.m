function [theta, loglikes] = pmcmc_flex_ricker(y,theta_init,iters,N,cov_rw)
%%
% pMCMC for flex ricker model
% inputs:
%   y - data
...
loglike_curr =  bootstrap_filter_flex_ricker([theta_curr(1) theta_curr(2) theta_curr(3) exp(theta_curr(4)) exp(theta_curr(5)) theta_curr(6)],y,N);
...
for i = 1:iters
    ...
    loglike_prop =   bootstrap_filter_flex_ricker([theta_prop(1) theta_prop(2) theta_prop(3) exp(theta_prop(4)) exp(theta_prop(5)) theta_prop(6)],y,N);
