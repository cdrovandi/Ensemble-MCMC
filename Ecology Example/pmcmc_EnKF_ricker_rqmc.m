function [theta, loglikes] = pmcmc_EnKF_ricker_rqmc(y,theta_init,iters,N,cov_rw)
%%
% eMCMC for Ricker model with rqmc extension
% inputs:
%   y - data
...
loglike_curr =  EnKF_ricker_rqmc([theta_curr(1) theta_curr(2) exp(theta_curr(3)) exp(theta_curr(4)) theta_curr(5)],y,N);
...
i    
    ...
    loglike_prop =   EnKF_ricker_rqmc([theta_prop(1) theta_prop(2) exp(theta_prop(3)) exp(theta_prop(4)) theta_prop(5)],y,N);
