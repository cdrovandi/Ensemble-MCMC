function [theta_samp] = pMCMC(iters,xinit,y,n,T,theta0,cov_rw,N,proposal_scale,sim_noise_scale,dt,steps_per_obs)
%Parameters:
%
...
loglike = BPF_Lorenz96(xinit,y,n,T,N,exp(theta(1:3)),exp(theta(4)),sim_noise_scale,dt,steps_per_obs);
...
loglike_prop = BPF_Lorenz96(xinit,y,n,T,N,exp(theta_prop(1:3)),exp(theta_prop(4)),sim_noise_scale,dt,steps_per_obs);
