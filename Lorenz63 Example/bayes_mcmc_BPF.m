function [theta_samp] = bayes_mcmc_BPF(iters,xinit,y,T,theta0,cov_rw,N,proposal_scale,sim_noise_scale,dt,steps_per_obs)
%Parameters:
%
...
loglike = BPF(xinit,y,T,N,exp(theta(1:3)),exp(theta(4:6)),sim_noise_scale,dt,steps_per_obs);
...
for i = 1:iters
    ...
    loglike_prop = BPF(xinit,y,T,N,exp(theta_prop(1:3)),exp(theta_prop(4:6)),sim_noise_scale,dt,steps_per_obs);
